		...
		<Fragment>
			<div className="blog-page">
				<div id="header">
					<img
						id="main_banner"
						src={new URL("./images/banner.png", import.meta.url).href}
						height="auto"
						width="100%"
						alt=""
					/>
					...
					<p className="paragraph_content">
						<b>
							...
							<span className="media_content_poster">
								<img
									className="poster"
									src={new URL("./images/session1.jpeg", import.meta.url).href}
									alt=""
								/>
								<img
									className="poster"
									src={new URL("./images/session2.jpeg", import.meta.url).href}
									alt=""
								/>
								<br />
							</span>{" "}
							...
							<span className="media_content">
								<img
									...
									src={new URL("./images/session1_meeting1.jpeg", import.meta.url).href}
									height="100%"
									width="90%"
									alt=""
								/>
								<img
									className="session_images"
									src={new URL("./images/session1_meeting2.jpeg", import.meta.url).href}
									height="100%"
									width="90%"
									alt=""
								/>
							...
							<span className="media_content">
								<img
									className="session_images"
									src={new URL("./images/session2_meeting1.jpeg", import.meta.url).href}
									height="100%"
									width="90%"
									alt=""
								/>
								<img
									className="session_images"
									src={new URL("./images/session2_meeting2.jpeg", import.meta.url).href}
									height="100%"
									width="90%"
									alt=""
								/>
					...
					<div className="footer-contents">
						<div className="footer-uni-section">
							<img
								...
								src={new URL("./images/amritalogo.png", import.meta.url).href}
								alt=""
							/>
							<img
								className="footer-uni-sites"
								src={new URL("./images/SSRLOGO.png", import.meta.url).href}
								alt=""
							/>
						</div>
						<hr></hr>
